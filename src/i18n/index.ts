      ...
      translation: {
        ...
        service: {
          ...
          attention: {
            title: "ВНИМАНИЕ!!!",
            illegal:
              "Вывоз бытовых и строительных отходов за пределы города либо на несанкционированные свалки запрещается и строго караются законом Республики Казахстан.",
            legislation:
              "В соответствии с законодательством Республики Казахстан все отходы подлежат вывозу на специализированные городские полигоны, где производится их надлежащая утилизация.",
            monitoring:
      ...
      translation: {
        ...
        service: {
          ...
          attention: {
            ...
            illegal:
              "Тұрмыстық және құрылыс қалдықтарын қаладан тыс жерге немесе рұқсат етілмеген полигондарға шығаруға тыйым салынады және бұл әрекеттер Қазақстан Республикасының заңнамасына сәйкес қатаң жазаланады.",
            legislation:
              "Қазақстан Республикасының заңнамасына сәйкес, барлық қалдықтар арнайы қалалық полигондарға шығарылып, онда тиісті түрде кәдеге жаратылады.",
            monitoring:
